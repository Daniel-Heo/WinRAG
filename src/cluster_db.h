...
* Description: 가중치 벡터와 관련 데이터를 저장하는 구조체로,
*              16바이트 정렬된 메모리를 사용하며 이동 연산만 지원
****************************************************************/
struct WeightEntry {
...
/****************************************************************
* Class Name: Cluster
* Description: 클러스터를 구성하는 중심 벡터와 포함된 데이터를 저장하는 클래스
****************************************************************/
class Cluster {
public:
...
* Description: 클러스터링을 활용하여 데이터를 저장하고 검색하는 데이터베이스 클래스
****************************************************************/
class ClusterDB {
private:
    int vectorDim;                        // 벡터 차원
